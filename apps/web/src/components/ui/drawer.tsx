  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Viewport
        ...
        data-modal={modal}
        className="visual-viewport-container pointer-events-none fixed inset-x-0 z-50 select-none [transform:translateZ(0)] data-[modal=true]:pointer-events-auto"
      >
        <DrawerPrimitive.Popup
          ...
          className={cn(
            ...
            // Sizing.
            "[--drawer-content-height:var(--drawer-height,auto)] data-[swipe-axis=x]:[--drawer-content-width:75%] data-[swipe-axis=y]:[--drawer-content-max-height:calc(var(--app-height)-6rem)] data-[swipe-axis=y]:data-snap-points:[--drawer-content-height:var(--app-height)] data-[swipe-axis=x]:sm:[--drawer-content-width:24rem]",
            // Stack.
