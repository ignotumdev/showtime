...
import type { LiveSongView } from "@/frontend/live/LiveSongView";
import { cn } from "@/lib/utils";

export function LiveSong({ song }: { readonly song: LiveSongView }) {
  return (
    <main className="mx-auto flex h-full w-full max-w-5xl flex-col justify-center overflow-hidden px-12 py-6 sm:px-16">
